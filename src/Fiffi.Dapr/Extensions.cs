...
public static class Extensions
{
    ...
    public static IServiceCollection AddDaprPubSubIntegrationEventPublisher(this IServiceCollection services, string pubsubname, string topicName)
        => services.AddSingleton(sp => sp.AddDaprPubSubIntegrationEventPublisher(pubsubname, topicName));

    public static Func<IEvent[], Task> AddDaprPubSubIntegrationEventPublisher(
    ...
    public static IServiceCollection AddDaprEventStore(this IServiceCollection services, string storeName = "statestore") =>
